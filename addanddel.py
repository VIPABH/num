...
async def raise_commands(event):
    ...
    commands = """
اوامر الرفع كالاتي:
1 ~  ترقية: لرفع المستخدم مشرف
2 ~  تنزيل مشرف: لتنزيل المستخدم من المشرفين
3 ~  رفع مطور ثانوي: لرفع المستخدم مطور ثانوي
4 ~  تنزيل مطور ثانوي: لتنزيل المستخدم من المطورين الثانويين
5 ~  رفع معاون: لرفع المستخدم معاون
6 ~  تنزيل معاون: لتنزيل المستخدم من المعاونين
7 ~  تغيير لقبي: لتغيير لقبك
8 ~  تغيير لقبه: لتغيير لقب المستخدم
9 ~  المخفي نزلني: لتنزيل نفسك من المشرفين
10 ~  مخفي نزل (ه|ها|ة): لتنزيل المستخدم من المشرفين
11 ~  المطورين الثانويين: لعرض قائمة المطورين الثانويين
12 ~  المعاونين: لعرض قائمة المعاونين
13 ~  حذف المعاونين: لحذف جميع المعاونين في المجموعة
    """
