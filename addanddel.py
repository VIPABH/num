...
async def raise_commands(event):
    ...
    commands = (
        ...
        "1. رفع مشرف (بالرد على رسالة المشرف)\n"
        "2. تنزيل مشرف (بالرد على رسالة المشرف)\n"
        "3. تغيير لقبي + اللقب الجديد\n"
        "4. ترقية (بالرد على رسالة المستخدم)\n"
        "5. مخفي نزلني\n"
        "6. مخفي نزل (بالرد على رسالة المشرف)\n"
        "7. رفع مطور ثانوي + (بالرد أو باليوزر أو بالآيدي)\n"
        "8. تنزيل مطور ثانوي + (بالرد أو باليوزر أو بالآيدي)\n"
        "9. المطورين الثانويين\n"
        "10. رفع معاون + (بالرد أو باليوزر أو بالآيدي)\n"
        "11. تنزيل معاون (بالرد على رسالة المستخدم)\n"
        "12. المعاونين\n"
        "13. حذف المعاونين"
    )
